...
<div class={cn('aspect-square size-8 rounded-full', className)}>
	...
	{:else}
		<div
			class="flex aspect-square items-center justify-center rounded-full bg-gradient-to-tr from-primary/10 via-cyan-300 to-emerald-600 text-primary-foreground"
		>
