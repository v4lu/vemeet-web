...
<MainWrapper class="bg-card pb-4 pt-0">
	<div class="space-y-6">
		{#if resp.isLoading}
			...
			<div class="space-y-1 rounded-lg">
				{#each resp.matches as match}
					<a
						...
						class="-mx-8 flex items-center space-x-4 border-b border-border px-8 py-4 transition-colors hover:bg-accent/50 md:p-4"
					>
						<div class="relative">
							<img
